...
function setStartTimer() {
    var endDate = new Date('Dec 10, 2022 20:00 UTC').getTime();
	...
	if (days < 10) { days = '0' + days; }
        ...
        $("#start-timer").html(`In ${days}d:${hours}h:${minutes}m:${seconds}s`);
